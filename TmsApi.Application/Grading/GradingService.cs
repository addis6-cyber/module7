...
public class GradingService
{
    ...
    public GradeLevel CalculateLetterGrade(
        decimal score,
        decimal maxScore)
    {
        ...
        return pct >= DistinctionThreshold
    ...
    public GradeLevel CalculateFromEnrollmentGrade(
        decimal? enrollmentGradePercent)
    {
        if (enrollmentGradePercent is null)
            return GradeLevel.Invalid;

        return CalculateLetterGrade(
            enrollmentGradePercent.Value,
            maxScore: 100m);
    }
}